...
export const updateFileById = async (token: string, id: string, form_data: object) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/files/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateExcelDataById = async (
	token: string,
	id: string,
	sheetName: string,
	data: any[][]
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/files/${id}/data/excel/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
